...
Olá, como vai?! Meu nome é Gabriel Miranda e acabei de fazer um projeto back end com intuito de praticar autenticação com json web token.
...
> **Project Feature:**  *aplicação web* 🌐 
 ...
 Este projeto consiste em uma APT REST feito com `nodejs(express.js)` e `mongoDB`, onde faço as seguintes funcionalidades:

 * Interação com o método( POST);
 * Cadastrar o usuário e retornar um token;
 * Criptografar a senha do usuário;
 * Fazer o login e retornar um token;
 * Editar o perfil do usuário só se estiver autenticado;
...
$ git clone https://github.com/Gabrielmirandaxl/back-end-jwt
